import {IN_DEVELOPMENT} from './testing'
...
{ const setReadOnlyError = {set: function (y) { console.error('ERROR: This Property is READONLY') }}
  ...
  Object.defineProperty(Date.prototype, 'TITLE',
    { get: function () { this.fmt = 'MM.DD YYYY'; return this }, ...setReadOnlyError })
  Date.prototype.formatDate = function(fm:any)
  {
    const dat = this,
          fmt = fm || this.fmt,
          amt = (s: string) => (fmt.match(new RegExp(s, 'gi')) || []).length
  ...
  Number.prototype.msOffset = function(amt:string)
...
//CONSOLE
console.devCount=0
console.dev = (key:string, ...opts:any) =>
{
  //USAGE
